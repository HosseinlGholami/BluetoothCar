...
; 0000 0012 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0013 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(240)
	OUT  0x17,R30
; 0000 0014 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0021 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	OUT  0x12,R30
; 0000 0022 
; 0000 0023 // Port E initialization
; 0000 0024 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0025 DDRE=(0<<DDE7) | (0<<DDE6) | (0<<DDE5) | (0<<DDE4) | (0<<DDE3) | (0<<DDE2) | (0<<DDE1) | (0<<DDE0);
	OUT  0x2,R30
; 0000 0026 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0027 PORTE=(0<<PORTE7) | (0<<PORTE6) | (0<<PORTE5) | (0<<PORTE4) | (0<<PORTE3) | (0<<PORTE2) | (0<<PORTE1) | (0<<PORTE0);
	OUT  0x3,R30
; 0000 0028 
; 0000 0029 // Port F initialization
; 0000 002A // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 002B DDRF=(0<<DDF7) | (0<<DDF6) | (0<<DDF5) | (0<<DDF4) | (0<<DDF3) | (0<<DDF2) | (0<<DDF1) | (0<<DDF0);
	STS  97,R30
; 0000 002C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 002D PORTF=(0<<PORTF7) | (0<<PORTF6) | (0<<PORTF5) | (0<<PORTF4) | (0<<PORTF3) | (0<<PORTF2) | (0<<PORTF1) | (0<<PORTF0);
	STS  98,R30
; 0000 002E 
; 0000 002F // Port G initialization
; 0000 0030 // Function: Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0031 DDRG=(0<<DDG4) | (0<<DDG3) | (0<<DDG2) | (0<<DDG1) | (0<<DDG0);
	STS  100,R30
; 0000 0032 // State: Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0033 PORTG=(0<<PORTG4) | (0<<PORTG3) | (0<<PORTG2) | (0<<PORTG1) | (0<<PORTG0);
	STS  101,R30
; 0000 0034 
; 0000 0035 // Timer/Counter 0 initialization
; 0000 0036 // Clock source: System Clock
; 0000 0037 // Clock value: 1000.000 kHz
; 0000 0038 // Mode: Fast PWM top=0xFF
; 0000 0039 // OC0 output: Non-Inverted PWM
; 0000 003A // Timer Period: 0.256 ms
; 0000 003B // Output Pulse(s):
; 0000 003C // OC0 Period: 0.256 ms Width: 0.016063 ms
; 0000 003D ASSR=0<<AS0;
	OUT  0x30,R30
; 0000 003E TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(106)
	OUT  0x33,R30
...
; 0000 004D // OC1A Period: 0.032 ms Width: 2.0078 us// OC1B Period: 0.032 ms Width: 2.6353 us// OC1C Period: 0.032 ms Width: 4.01 ...
...
; 0000 0052 // Compare C Match Interrupt: Off
; 0000 0053 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (1<<COM1C1) | (0<<COM1C0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(169)
	OUT  0x2F,R30
; 0000 0054 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(9)
	OUT  0x2E,R30
...
; 0000 0059 OCR1AH=0x00;
	OUT  0x2B,R30
; 0000 005A OCR1AL=0x10;
	LDI  R30,LOW(16)
	OUT  0x2A,R30
; 0000 005B OCR1BH=0x00;
	LDI  R30,LOW(0)
	OUT  0x29,R30
; 0000 005C OCR1BL=0x15;
	LDI  R30,LOW(21)
	OUT  0x28,R30
; 0000 005D OCR1CH=0x00;
	LDI  R30,LOW(0)
	STS  121,R30
; 0000 005E OCR1CL=0x20;
	LDI  R30,LOW(32)
	STS  120,R30
; 0000 005F 
...
; 0000 0064 // OC2 output: Non-Inverted PWM
; 0000 0065 TCCR2=(1<<WGM20) | (1<<COM21) | (0<<COM20) | (1<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	LDI  R30,LOW(104)
	OUT  0x25,R30
...
; 0000 0067 OCR2=0x70;
	...
	OUT  0x23,R30
; 0000 0068 
; 0000 0069 // Timer/Counter 3 initialization
; 0000 006A // Clock source: System Clock
; 0000 006B // Clock value: Timer3 Stopped
; 0000 006C // Mode: Normal top=0xFFFF
; 0000 006D // OC3A output: Disconnected
; 0000 006E // OC3B output: Disconnected
; 0000 006F // OC3C output: Disconnected
...
; 0000 0077 TCCR3A=(0<<COM3A1) | (0<<COM3A0) | (0<<COM3B1) | (0<<COM3B0) | (0<<COM3C1) | (0<<COM3C0) | (0<<WGM31) | (0<<WGM30);
	LDI  R30,LOW(0)
	STS  139,R30
; 0000 0078 TCCR3B=(0<<ICNC3) | (0<<ICES3) | (0<<WGM33) | (0<<WGM32) | (0<<CS32) | (0<<CS31) | (0<<CS30);
	STS  138,R30
; 0000 0079 TCNT3H=0x00;
	STS  137,R30
; 0000 007A TCNT3L=0x00;
	STS  136,R30
; 0000 007B ICR3H=0x00;
	STS  129,R30
; 0000 007C ICR3L=0x00;
	STS  128,R30
; 0000 007D OCR3AH=0x00;
	STS  135,R30
; 0000 007E OCR3AL=0x00;
	STS  134,R30
; 0000 007F OCR3BH=0x00;
	STS  133,R30
; 0000 0080 OCR3BL=0x00;
	STS  132,R30
; 0000 0081 OCR3CH=0x00;
	STS  131,R30
; 0000 0082 OCR3CL=0x00;
	STS  130,R30
; 0000 0083 
...
; 0000 0085 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x37,R30
; 0000 0086 ETIMSK=(0<<TICIE3) | (0<<OCIE3A) | (0<<OCIE3B) | (0<<TOIE3) | (0<<OCIE3C) | (0<<OCIE1C);
	STS  125,R30
; 0000 0087 
...
; 0000 008F // INT6: Off
; 0000 0090 // INT7: Off
; 0000 0091 EICRA=(0<<ISC31) | (0<<ISC30) | (0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  106,R30
; 0000 0092 EICRB=(0<<ISC71) | (0<<ISC70) | (0<<ISC61) | (0<<ISC60) | (0<<ISC51) | (0<<ISC50) | (0<<ISC41) | (0<<ISC40);
	OUT  0x3A,R30
; 0000 0093 EIMSK=(0<<INT7) | (0<<INT6) | (0<<INT5) | (0<<INT4) | (0<<INT3) | (0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x39,R30
; 0000 0094 
...
; 0000 009B UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (0<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	STS  154,R30
; 0000 009C 
...
; 0000 00A8 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00A9 
